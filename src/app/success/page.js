...
const Success = () => {
  return (
    <div className="bg-gray-100 min-h-screen">
      <Header />
      <main className="max-w-screen-lg mx-auto mt-10 px-4">
        <div className="flex flex-col bg-white p-8 rounded shadow-md">
          ...
          <Link href={"/orders"} className="flex flex-col w-full">
            <button className="sm:w-auto button mt-8">Go to my orders</button>
          </Link>
        </div>
      </main>
    </div>
